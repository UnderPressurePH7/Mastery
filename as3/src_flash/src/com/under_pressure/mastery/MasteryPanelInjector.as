package com.under_pressure.mastery
{
    ...
    public class MasteryPanelInjector extends AbstractView
    {
        ...
        public function as_setMasteryData(third:int, second:int, first:int, ace:int):void
        {
            if (!_configDone)
            {
                _pendingCalls.push({fn: this.as_setMasteryData, args: [third, second, first, ace]});
                return;
            }
        ...
        public function as_setMoeData(p65:int, p85:int, p95:int, p100:int):void
        {
            if (!_configDone)
            {
                _pendingCalls.push({fn: this.as_setMoeData, args: [p65, p85, p95, p100]});
                return;
            }
        ...
        public function as_setLoading():void
        {
            if (!_configDone)
            {
                _pendingCalls.push({fn: this.as_setLoading, args: []});
                return;
            }
        ...
        public function as_clearData():void
        {
            if (!_configDone)
            {
                _pendingCalls.push({fn: this.as_clearData, args: []});
                return;
            }
        ...
        public function as_setLocalization(data:Object):void
        {
            if (!_configDone)
            {
                _pendingCalls.push({fn: this.as_setLocalization, args: [data]});
                return;
            }
